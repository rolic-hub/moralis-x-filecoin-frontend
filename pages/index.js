    ...
    <div className="flex w-screen">
      ...
      <div className="bg-green-500 w-1/2 h-screen flex flex-col">
        <div className="flex pt-14 pl-20 items-center ">
          ...
          <p className="ml-3 mt-5 text-3xl font-bold text-white">A Giving System</p>
        </div>
        <p className="mt-10 ml-36 font-semibold w-64 text-white">Help build us a better world by donating to a cause today</p>
