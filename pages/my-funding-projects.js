...
const MyfundingProjects = () => {
  return (
    <div>
      <Layout>
        <div>
          <div className="flex "><p className="text-3xl font-bold text-green-600">
            My Funding Projects
          </p>
          <button>Create a new cause</button></div>
          <div className="mt-10 border rounded-lg shadow-md w-60">
            ...
            <progress className="ml-20 h-3 rounded-lg bg-transparent mb-3 w-36" max="100" value="50"/>
          </div>
        </div>
      </Layout>
    </div>
